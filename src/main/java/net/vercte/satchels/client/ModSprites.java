...
public class ModSprites {
    public static final ResourceLocation SATCHEL_INVENTORY = Satchels.at("satchel_inventory");
    public static final ResourceLocation SATCHEL_HOTBAR = Satchels.at("satchel_hotbar");
